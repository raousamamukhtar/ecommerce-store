...
import RelatedProducts from "@/app/Components/Shares/RelatedProducts";
...
export default function Page({ params }: { params: { id: string } }) {
  ...
  //   // const item = JSON.parse(localStorage.getItem("cart") as string);
            ...
            <Wrapper>
              {data &&
                data.map((product: any) => (
                  <div className="flex flex-col lg:flex-row md:px-10 gap-[50px] lg:gap-[100px] px-8">
                    {/* left column start */}
                    ...
                    <div className="flex-[1] py-3 ">
                      ...
                      >
                        {loader.buttonLoading && <FaSpinner size={20} />}
                        <p>Add to Cart</p>
                      </button> */}
